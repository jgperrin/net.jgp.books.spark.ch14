...
object AdditionScalaApp {
  ...
  def main(args: Array[String]): Unit = {
    ...
    spark.udf.register("add_int", new IntegerAdditionScalaUdf, DataTypes.IntegerType)
    spark.udf.register("add_string", new StringAdditionScalaUdf, DataTypes.StringType)
